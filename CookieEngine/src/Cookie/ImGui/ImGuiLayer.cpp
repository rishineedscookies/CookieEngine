...
namespace Cookie {
	...
	void ImGuiLayer::OnAttach()
	{
		...
		// TEMPORARY: should eventually use Cookie key codes
	...
	void ImGuiLayer::OnEvent(Event& event)
	{
		...
		dispatcher.Dispatch<MouseScrolledEvent>(CK_BIND_EVENT_FN(ImGuiLayer::OnMouseScrolledEvent));
		...
		dispatcher.Dispatch<WindowResizeEvent>(CK_BIND_EVENT_FN(ImGuiLayer::OnWindowResizeEvent));
	}
